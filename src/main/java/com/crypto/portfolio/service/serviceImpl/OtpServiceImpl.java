...
import com.crypto.portfolio.service.OtpService;
import com.crypto.portfolio.utils.otp.HashOtpUtils;
...
public class OtpServiceImpl implements OtpService {
    ...
    public void saveOtp(Long userId, String rawOtp) {
        ...
        String hashedOtp = HashOtpUtils.hmacSha256(rawOtp, String.valueOf(userId), otpSecret);
